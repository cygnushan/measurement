...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_10.setText(_translate("Dialog", "电流量程", None))
        self.IV_range.setItemText(0, _translate("Dialog", "AUTO", None))
        self.IV_range.setItemText(1, _translate("Dialog", "10pA", None))
        self.IV_range.setItemText(2, _translate("Dialog", "100pA", None))
        self.IV_range.setItemText(3, _translate("Dialog", "1uA", None))
        self.IV_range.setItemText(4, _translate("Dialog", "10uA", None))
        self.IV_range.setItemText(5, _translate("Dialog", "100uA", None))
        self.IV_range.setItemText(6, _translate("Dialog", "1mA", None))
        self.IV_range.setItemText(7, _translate("Dialog", "10mA", None))
        self.IV_range.setItemText(8, _translate("Dialog", "100mA", None))
        self.IV_range.setItemText(9, _translate("Dialog", "1A", None))
        ...
        self.label_11.setText(_translate("Dialog", "电压量程", None))
        self.VI_range.setItemText(0, _translate("Dialog", "AUTO", None))
        self.VI_range.setItemText(1, _translate("Dialog", "1uV", None))
        self.VI_range.setItemText(2, _translate("Dialog", "10uV", None))
        self.VI_range.setItemText(3, _translate("Dialog", "100uV", None))
        self.VI_range.setItemText(4, _translate("Dialog", "1mV", None))
        self.VI_range.setItemText(5, _translate("Dialog", "10mV", None))
        self.VI_range.setItemText(6, _translate("Dialog", "100mV", None))
        self.VI_range.setItemText(7, _translate("Dialog", "1V", None))
        self.VI_range.setItemText(8, _translate("Dialog", "10V", None))
