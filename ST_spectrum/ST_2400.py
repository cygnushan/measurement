...
class UI_ST2400(QDialog, Ui_UI_sens2400):
    ...
    def on_output_mode_currentIndexChanged(self, index):
        if index == 0:
            qmdz_const.OUTPUT_MODE = 0
        else:
            qmdz_const.OUTPUT_MODE = 1
        print qmdz_const.OUTPUT_MODE
    ...
    @pyqtSignature("")
    def on_ST2400_save_clicked(self):
        """
        Slot documentation goes here.
        """
        # TODO: not implemented yet
...
def set_value(key,value):
    write_config(qmdz_const.ST_CONF_PATH, 'INST', key, value)
    return value
